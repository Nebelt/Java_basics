...
public class RouteCalculator {
    ...
    public RouteCalculator(StationIndex stationIndex) {
        RouteCalculator.stationIndex = stationIndex;
    }
    ...
    public static List<Station> getRouteOnTheLine(Station from, Station to) {
    ...
    private List<Station> getRouteWithOneConnection(Station from, Station to) {
        ...
        for (Station station_line1 : fromLineStations) {
            for (Station station_line2 : toLineStations) {
                if (isConnected(station_line1, station_line2)) {
                    flag = true;
                }
            }
